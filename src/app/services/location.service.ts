...
export class LocationService {
  ...
  saveUbi(ubicacion:any){
    const refContacto = this.afs.collection("ubicaciones");
    if(ubicacion.uid==null){
      ubicacion.uid = this.afs.createId();
    }
      

    refContacto.doc(ubicacion.uid).set(Object.assign({}, ubicacion), { merge: true})
  }

  getUbis(): Observable<any[]>{
